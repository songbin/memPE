...
3.the strategy about this project
  ...
  3.2 Which are the enabled memcached command in this project?
       you can use all of memcached asccii commands in this project.Now the binary protocol without persistence store 
...
6.How to lauch?
memcached -p 11212 -T/data/test.tdb 
then , the persistence will be stored in /data/test.tdb
